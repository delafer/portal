...
INSERT INTO user (id, username, password, firstname, lastname) VALUES (3, 'test', 'test', 'Vladimir', 'Putin');
INSERT INTO user (id, username, password, firstname, lastname) VALUES (4, 'angela', 'start123', 'Angela', 'Merkel');
